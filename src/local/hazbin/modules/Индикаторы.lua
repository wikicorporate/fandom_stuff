...
local Nameplate = {
    ...
    ["Неактуальная статья"] = {"<i class='fa-solid fa-pen-ruler'></i>Неактуальная статья", "mw-indicator__nameplate--old", "Это [[:Категория:Неактуальные статьи|неактуальная статья]].</span> Информация, содержащаяся в данной статье, была получена из источников, которые на данный момент не являются достоверными. Элементы канона были переработаны или удалены.[[Категория:Неактуальные статьи]]"},
    ["Короткая статья"] = {"<i class='fa-solid fa-newspaper'></i>Короткая статья", "mw-indicator__nameplate--short", "Это [[:Категория:Короткие статьи|короткая статья]].</span> Она содержит неполную информацию. Вы можете помочь '''{{SITENAME}}''', [{{SERVER}}{{localurl:{{NAMESPACE}}:{{PAGENAME}}|action=edit}} дополнив её].</span>[[Категория:Короткие статьи]]"},
    ["Неканон"] = {"<i class='fa-solid fa-scroll'></i> Неканон", "mw-indicator__nameplate--noncanon", "Это [[:Категория:Неканон|неканоничная статья]].</span> Информация на данной странице не относится к канону.[[Категория:Неканон]]"},
